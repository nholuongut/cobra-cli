...
Install the cobra generator with the command `go install github.com/nholuongut/cobra-cli@latest`. 
...
mkdir myapp
cd myapp
go mod init github.com/nholuongut/myapp
```
...
cobra-cli init can also be run from a subdirectory such as how the [cobra generator itself is organized](https://github.com/nholuongut/cobra-cli).
...
e.g. `cobra-cli init --author "Steve Francia spf@nholuongut.com"`
...
For complete details on using the Cobra library, please read the [The Cobra User Guide](https://github.com/nholuongut/cobra/blob/main/site/content/user_guide.md#using-the-cobra-library).
...
```
Copyright © 2020 Nho Luong <luongutnho@hotmail.com>
