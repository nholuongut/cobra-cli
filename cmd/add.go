// Copyright © 2015 Nho Luong <luongutnho@hotmail.com>
//
...
func init() {
	addCmd.Flags().StringVarP(&packageName, "package", "t", "", "target package name (e.g. github.com/nholuongut/hugo)")
...
// https://github.com/nholuongut/cobra/issues/269
